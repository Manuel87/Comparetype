...
globalVars.myReadingFontsize = {
	size: "9.5 arcmin", //cm //mm // pt (space is important)
	min: 7 //(is pixel); //cm //mm // pt (space is important)
}
   ...
   if(Mac) {
    ...
    //my awful written conditions
      ...
      if(iPhone) { //http://de.wikipedia.org/wiki/IPhone
        ...
        else if(myWidth === 375 || myHeight === 375) {
              newDiagonal = 4.7; //375px x 667px Iphone 6 // 2 csspixel //4.6Inch //4,7 Zoll (11,94 cm) 326
        }
        else if(myWidth === 414 || myHeight === 414) {
        	globalVars.preset.csspixel = globalVars.initial.csspixel = 1080/414;

            newDiagonal = 5.5; //414 736px iphone6 plus // 2.6 csspixel (3 downscaled  by 1.15)  -  5,5 Zoll (13,94 cm) 401 ppi


        }
      }
      else if(myWidth === 1024 || myHeight === 1024) { //2048
          globalVars.preset.distance = 45;
          //newDiagonal = 9.7;// IPAD // 7.9 Ipad Mini
      ...
      else if(myWidth === 1152) { //2304
        if(myHeight === 720) {
          newDiagonal = 12;// Macbook 12 (2015)

        }
      }
      else if(myWidth === 1366) {
        if(myHeight === 768) {
          newDiagonal = 11.6;//33.78; Macbook Air 11.6
        }
      }
      else if(myWidth === 1280) { //2560
        if(myHeight === 800) { //1600
          newDiagonal = 13.3;//33.78cm; // MacBook +  Pro (Regular + Retina)
        }
      }
      else if(myWidth === 1440) { //2880
        if(myHeight === 900) {
          if(myCSSpixel > 1 && myCSSpixel < 2) {
            newDiagonal = 13.3;// Macbook Air 13.3
          } else {
            newDiagonal = 15.4;// Macbook 15.4
          }
        }
      }
        ...
        if(myHeight === 1080) {
          newDiagonal = 21.5; //I Mac
          globalVars.preset.distance = 80;
        }
      }
      else if(myWidth === 2560) { //2560
        if(myHeight === 1600) { //1600
          newDiagonal = 13.3;//33.78cm; // MacBook +  Pro (Retina, volle Auflösung)
        }
      }
      else if(myWidth === 2880) { //2880
        if(myHeight === 1800) {
          if(myCSSpixel === 1 && myCSSpixel < 2) {
            newDiagonal = 15.4;// Macbook 15.4 Retina auf voller Auflösung
          } else {
            newDiagonal = 15.4;// gibts eigentlich nicht???
          }
        }
      }
      else if(myWidth === 2560) { // 5120
        if(myHeight === 1440) {
          newDiagonal = 27; //iMac // Thunderbolt Display
          globalVars.preset.distance = 80;
        }
      }
      if(newDiagonal > 0) {
        globalVars.preset.diagonal = newDiagonal;
