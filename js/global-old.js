...
globalVars.measure_fontsize = 100;
...
globalVars.UIList = [{
    ...
    content: [{
        name: "Typographic Sizing", // Title/Name of this UI Field
    ...
    },
    {
        ...
        initFunc: "toggle", // Func to be run on init, determines what kind of field ( must be in ManusComperator.prototype.GetUI )
        //changeFunc: "flipHochizontal", // Func to be run when something in the field is changed ( must be in ManusComperator.prototype.GetUIFunc )
        //
        //submitchangeFunc: ".char",
        //changeVar: "flipChar",
        //"default": false
    }, ]
}, {
